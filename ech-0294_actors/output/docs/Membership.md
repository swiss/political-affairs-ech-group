...
[en] Reference to a person with snapshot data at time of linking.
 |
| group_reference | 0..1 <br/> [GroupReference](GroupReference.md) | [de] Referenz auf eine Gruppe mit Snapshot-Daten zum Zeitpunkt der Verknüpfung.
...
[de] Rolle der Person in der Mitgliedschaft oder Funktion.
 |
| authorized_to_vote | 0..1 <br/> [Boolean](Boolean.md) | [de] Gibt an, ob die Person stimmberechtigt ist.
