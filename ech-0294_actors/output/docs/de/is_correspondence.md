...
_Gibt an, ob es sich um die bevorzugte Sprache handelt._
...
| Domäne von | [LanguageProficiency](LanguageProficiency.md) |
...
annotations:
  ...
  description_fr:
    ...
    value: 'Indique s''il s''agit de la langue préférée.
      ...
      '
description: 'Gibt an, ob es sich um die bevorzugte Sprache handelt.
