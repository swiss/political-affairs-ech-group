...
| Eigenschaft | Wert |
| --- | --- |
| Wertebereich | [GroupTypeEnum](GroupTypeEnum.md) |
| Domäne von | [GroupType](GroupType.md) |
...
annotations:
  ...
  description_fr:
    ...
    value: 'Lien vers le vocabulaire contrôlé pour les types de groupes.
      ...
      '
description: 'Link zum kontrollierten Vokabular für Gruppentypen.

  '
examples:
- value: association
- value: committee
- value: committee_extraparliamentary
