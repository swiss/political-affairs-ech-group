...
[en] Indicates if the position is paid.
 |
| occupation_code | 0..1 <br/> [String](String.md) | [de] ISCO-19 Code der Tätigkeit.
...
[en] Option to assign a label to a structured piece of information (e.g., display name, position, etc.).
 |
| enterprise_uid | 0..1 <br/> [String](String.md) | [de] UID des Unternehmens.
[en] UID of the enterprise.
 |
| enterprise | 0..1 <br/> [String](String.md) | [de] Name des Unternehmens.
