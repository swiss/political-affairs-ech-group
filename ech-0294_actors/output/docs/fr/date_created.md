...
_La date à laquelle une entité a été créée._
...
| URI du slot | [mcm:dateCreated](https://ld.ech.ch/schema/0292/meta-common/dateCreated) |
...
annotations:
  ...
  description_fr:
    ...
    value: 'La date à laquelle une entité a été créée.
      ...
      '
description: 'La date à laquelle une entité a été créée.
