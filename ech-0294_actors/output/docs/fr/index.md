...
| [address_uri](address_uri.md) | URI de l'adresse issue du Répertoire officiel des adresses de bâtiments (swis... |
...
| [electoral_district](electoral_district.md) | Circonscription électorale de l'affiliation |
...
| [interest_type](interest_type.md) | Type de lien d'intérêts, suivant les catégories tenues par les registres de p... |
...
| [organization_name](organization_name.md) | Nom de l'organisation ou de l'entreprise, avec la langue dans laquelle il est... |
...
| [GroupTypeEnum](GroupTypeEnum.md) | Vocabulaire contrôlé pour le type d'un groupe |
