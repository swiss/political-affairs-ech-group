...
_La date de début planifiée d'un événement ou d'une occurrence avec durée._
...
| URI du slot | [mcm:dateBeginPlanned](https://ld.ech.ch/schema/0292/meta-common/dateBeginPlanned) |
...
annotations:
  ...
  description_fr:
    ...
    value: 'La date de début planifiée d''un événement ou d''une occurrence avec durée.
      ...
      '
description: 'La date de début planifiée d''un événement ou d''une occurrence avec
  durée.
