...
| label | 0..1 <br/> [String](String.md) | Désignation de la circonscription électorale telle qu'elle est publiée par l'organe compétent pour l'élection.  |
...
### Exemples
#### Exemple : Electoral district without an official spatial unit
...
```
#### Exemple : Canton as electoral district identified via its LINDAS resource
