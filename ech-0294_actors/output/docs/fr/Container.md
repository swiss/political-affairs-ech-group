...
# eindeutig bezeichnen: wo die publizierende Stelle eine gruppenspezifische
# Adresse führt, wird diese verwendet; führt sie nur eine Übersichtsseite über
# alle Fraktionen bzw. Kommissionen, steht dort die eindeutige URI der Plattform
# openparldata.ch, über die die Daten bezogen wurden, und die amtliche Übersicht
# erscheint als `landing_page`. `local_id` ist die Kennung von openparldata.ch.
#
...
groups:
  ...
  # Ausserparlamentarische Kommission des Bundes. Sie zeigt, dass sich der Typ
  # nicht über die Hierarchie bestimmt: Ihre Mitglieder sind externe Fachleute,
  # nicht Ratsmitglieder, und sie stützt sich auf das Organisationsrecht von
  # Regierung und Verwaltung. Als Behördenkommission entscheidet sie an Stelle
  # der Verwaltung, statt sie bloss zu beraten.
  ...
  # Ständige Kommission mit gebräuchlicher Abkürzung
  - local_id: 3
