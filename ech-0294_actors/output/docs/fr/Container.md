...
# echte Fälle aus der Plattform openparldata.ch; `global_uri` verweist auf den
# jeweiligen API-Datensatz, `local_id` ist die dortige Kennung.
#
...
groups:
  ...
  - local_id: 700
    global_uri: https://api.openparldata.ch/v1/groups/700
    label:
