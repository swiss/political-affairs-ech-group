...
groups:
  ...
  # Ständige Kommission mit gebräuchlicher Abkürzung. Der Verweis auf den
  # Kantonsrat zeigt, dass eine übergeordnete Gruppe über ihre URI benannt wird
  # und nicht in derselben Lieferung enthalten sein muss — erst dieser Verweis
  # macht sichtbar, welchem Rat die Kommission zugehört.
  - local_id: 3
