...
The meeting dates and Teams links of the subgroups are given here: [meeting dates of the subgroups](docs/managment/meeting_dates_subgroups.md).
...
- [GitHub Actions Workflows](.github/workflows/README.md): A document describing the architecture of the GitHub Actions workflow used to generate documentation from the LinkML data schemata.
