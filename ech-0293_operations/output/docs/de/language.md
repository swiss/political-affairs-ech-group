...
| [MultilingualString](MultilingualString.md) | Ein String, der Text in mehreren Sprachen enthalten kann |  yes  |
...
| Domäne von | [Speech](Speech.md), [MultilingualString](MultilingualString.md), [MultilingualValue](MultilingualValue.md), [MultilingualUri](MultilingualUri.md) |
