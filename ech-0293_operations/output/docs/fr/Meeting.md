...
### Exemples
#### Exemple : Council of States sitting with protocol and speeches
...
```
#### Exemple : Cantonal parliament sitting with agenda items and votings
...
```
#### Exemple : Half-day sitting within a session
...
```
#### Exemple : Committee sitting with an attendance list
...
```
#### Exemple : Government sitting with a bilingual designation
...
```
#### Exemple : Landsgemeinde as meeting type sitting
