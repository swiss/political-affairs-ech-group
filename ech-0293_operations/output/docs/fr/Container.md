...
| legislatures | * <br/> [Legislature](Legislature.md) | Ensemble des législatures.  |
| sessions | * <br/> [Session](Session.md) | Ensemble des sessions.  |
| meetings | * <br/> [Meeting](Meeting.md) | Ensemble des séances.  |
| protocols | * <br/> [Protocol](Protocol.md) | Ensemble des procès-verbaux.  |
| votings | * <br/> [Voting](Voting.md) | Ensemble des votes.  |
| elections | * <br/> [Election](Election.md) | Ensemble des élections.  |
| individual_votes | * <br/> [IndividualVote](IndividualVote.md) | Ensemble des voix individuelles.  |
| attendances | * <br/> [Attendance](Attendance.md) | Ensemble des listes de présence.  |
| individual_attendances | * <br/> [IndividualAttendance](IndividualAttendance.md) | Ensemble des constatations individuelles de présence.  |
| speeches | * <br/> [Speech](Speech.md) | Ensemble des interventions.  |
| resolutions | * <br/> [Resolution](Resolution.md) | Ensemble des décisions.  |
