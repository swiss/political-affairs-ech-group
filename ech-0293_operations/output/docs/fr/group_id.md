...
_Référence au groupe ou à l'organe (instantané au moment de la mise en relation)._
...
annotations:
  ...
  description_fr:
    ...
    value: 'Référence au groupe ou à l''organe (instantané au moment de la mise en
      ...
      '
description: 'Référence au groupe ou à l''organe (instantané au moment de la mise
  en relation).
