...
| parent_meeting | 0..1 <br/> [String](String.md) | The linked meeting ID that groups the current meeting. <br/><br/>Inheritance: [IsAgendaItem](IsAgendaItem.md) |
...
| parent_agenda_item | 0..1 <br/> [String](String.md) | If needed, this slot builds a hierarchy of agenda items. <br/><br/>Inheritance: [IsAgendaItem](IsAgendaItem.md) |
