...
| [MultilingualString](MultilingualString.md) | A string that can contain text in multiple languages |  yes  |
...
| Domain Of | [Speech](Speech.md), [MultilingualString](MultilingualString.md), [MultilingualValue](MultilingualValue.md), [MultilingualUri](MultilingualUri.md) |
