...
URI: [tutorial:HasTemporalValidity](https://ch.paf.link/schema/tutorial/HasTemporalValidity)
...
| ---  | ---  |
| self | tutorial:HasTemporalValidity |
| native | tutorial:HasTemporalValidity |
