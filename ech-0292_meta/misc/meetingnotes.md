...
- Themenklassifikation: vgl. https://github.com/swiss/political-affairs-ech-group/blob/main/ech-0297_consultations/misc/2026-06-19-session.md
    ...
    - Draft via separates Kapitel starten, aber erst für nächste Version des Meta-Standards: https://github.com/swiss/political-affairs-ech-group/blob/main/ech-0292_meta/input/de/08_topic_list.md
...
- 05_data_publishing.md
    - https://github.com/swiss/political-affairs-ech-group/blob/main/ech-0292_meta/input/de/05_data_publishing.md
...
- Nächstes Thema für Subgruppe (siehe [Gap-Analyse unten](https://github.com/swiss/political-affairs-ech-group/blob/main/ech-0292_meta/misc/meetingnotes.md#mini-gap-analysis-inkl-er%C3%A4nzungen-1006)) - Priorisierung - Feedback aus FG morgen
...
- Benedikt stellt https://github.com/swiss/political-affairs-ech-group/blob/main/ech-0292_meta/input/schema_common.yaml vor: Dieses Schema stellt gemeinsame Elemente (Klassen, Slots) zur Nutzung in anderen eCH LinkML Schemata zur Verfügung. Das muss noch besser dokumentiert werden, damit alle wissen, was dort vorhanden ist und insbesondere soll auf höherer Abstraktionsebene beschrieben werden, welche "Mechanismen" schon gelöst/vorhanden sind.
